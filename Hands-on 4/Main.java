...
public class Main {
	...
	public static void main(String[] args) {
		...
		int muestra[][] = new int[TOTAL_COLUMNAS][N], advertising;
		double promedioAdvertising = 0, promedioSales = 0, desviacionAdvertising = 0, desviacionSales = 0;
		double covarianza = 0, sales, beta1 = 0, beta0 = 0;
		...
		System.out.println("Ingresa el valor de ADVERTISING: ");
		advertising = leer.nextInt();
